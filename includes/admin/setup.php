...
namespace ProxiIdVerification\Admin;

/**
 * ProxiIdVerification Setup Class
 */
class Setup {
	/**
	 * Constructor.
	...
	public function register_scripts() {
		...
		wp_enqueue_script( 'proxi-id-verification' );
		wp_enqueue_style( 'proxi-id-verification' );
	}
	...
	public function register_page() {
		...
		wc_admin_register_page(
			array(
				'id'     => 'proxi_id_verification-example-page',
				'title'  => __( 'Proxi Id Verification', 'proxi_id_verification' ),
				'parent' => 'woocommerce',
				'path'   => '/proxi-id-verification',
			)
		);
	}
}
